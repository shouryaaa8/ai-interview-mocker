...
function Header() {
  ...
  return (
    <div className='flex px-4 items-center justify-between bg-secondary shadow-sm'>
      <img src="https://assets.grok.com/users/6f79ec4b-b50b-4c97-aeb8-3d1102be3730/generated/oi7MpPprayD5Vwlb/image.jpg" alt="logo" width={100} height={100} className='h-fit w-36' />
